    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <nav id="sidebar" class="col-md-3">
                ...
                <ul class="list-group">
                    <li class="list-group-item"><a href="https://sites.google.com/view/the-spice-point-of-sale?usp=sharing" target="_blank">Google Site</a></li>
                    <li class="list-group-item"><a href="https://www.linkedin.com/in/rahulbagda1212/" target="_blank">LinkedIn</a></li>
                    <li class="list-group-item"><a href="https://www.blog.com" target="_blank">Blog</a></li>
                    <li class="list-group-item"><a href="https://github.com/rahulbagda1212" target="_blank">GitHub</a></li>
                </ul>
            </nav>
            <!-- Main content -->
            <main class="col-md-9">
    ...
    <img src="logo.png" alt="Logo" width="100" class="float-right rounded-custom">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button"><a href="https://github.com/rahulbagda1212/web_development_using_php/tree/main/task1" target="_blank">Task 1</a></button>
<button class="sunset-orange-button gradient-button"><a href="https://github.com/rahulbagda1212/web_development_using_php/tree/main/task2" target="_blank"> Task 2</a></button>
<button class="spring-green-button gradient-button"><a href="https://github.com/rahulbagda1212/web_development_using_php/tree/main/task1" target="_blank">Task 3</a></button>
